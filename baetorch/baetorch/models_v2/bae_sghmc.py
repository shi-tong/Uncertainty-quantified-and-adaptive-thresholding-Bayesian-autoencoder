    ...
    def fit(
        ...
        **fit_kwargs
        ...
        if sghmc_epoch > 0:
            ...
            # print(f"save_every={self.save_every}, sghmc_epoch={sghmc_epoch}, num_samples={self.num_samples}")
    ...
    def step_scheduler(self):
        ...
        if self.burn_stage:
            ...
            if self.save_every == 0:
                self.save_every = 1  # Or any other positive integer value to avoid division by zero
