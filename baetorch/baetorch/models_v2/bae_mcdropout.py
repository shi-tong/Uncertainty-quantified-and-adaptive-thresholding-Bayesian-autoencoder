...
# import torch
# from baetorch.baetorch.models_v2.base_autoencoder import BAE_BaseClass, AutoencoderModule
...
#         stacked_criterion = torch.stack(
#             [
#                 super(BAE_MCDropout, self).criterion(self.autoencoder, {"x": x_input, "c": c}, y=y)
#                 for i in range(self.num_train_samples)
#             ]
#         )
#         return stacked_criterion.mean()